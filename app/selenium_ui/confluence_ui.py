...
def test_1_selenium_custom_action2(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    extension_ui.banner_is_appearing(confluence_webdriver, confluence_datasets)
